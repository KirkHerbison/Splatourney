            ...
            <div>
                ...
                <select name="tournamentType" id="tournamentType">
                    <?php foreach ($tournamnetTypes as $type) { ?>
                        <option value="<?php echo $type->getId(); ?>" <?php
                        if ($type->getId() == $tournament->getTournamentTypeId()) {
                            echo "selected";
                        }
                        ?>><?php echo $type->getDescription(); ?></option>
<?php } ?>        
                </select>
            </div>
            <br>
        ...
        <form action="tournament_manager/index.php" method="POST">
            ...
            <div>
                ...
                <select name="tournamentTypeId" id="tournamentTypeId">
                    <?php foreach ($tournamnetTypes as $type) { ?>
                        <option value="<?php echo $type->getId(); ?>"  <?php if ($type->getId() == $tournament->getTournamentTypeId()) { echo "selected"; }?>>
            ...
            <div class="round">
                <select  name="mapSelect" id="mapSelect">
                    <?php foreach (maps as $map) { ?>
                        <option value="<?php echo $map->getId(); ?>">
